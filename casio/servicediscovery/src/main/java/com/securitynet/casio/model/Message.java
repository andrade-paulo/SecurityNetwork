...
public class Message {
    ...
    public String buildMessageWithHmac(byte[] aesKey) throws Exception {
        String content = this.getContent();
        
        byte[] hmacBytes = Util.calculateHmacSha256(aesKey, content.getBytes());
        this.hmac = Util.bytes2Hex(hmacBytes);
